...
function [q,u,gamma,tau] = paramaker_tau(q_start, q_end, q_points, u_start, u_end, u_points, gam_start, gam_end, gam_points, tau_start, tau_end, tau_point)
...
%%% ↓お試し用：入力数値コマンド
%paramaker_tau(0.01745, 0.5236, 3, 0.256, 2.56, 3, 0.001, 1.57, 3, 0.001, 0.01, 5)
