...
function [q,u,gamma,tau] = paramaker_k_tau_Garcia_default(q_start, q_end, q_points, u_start, u_end, u_points, gam_start, gam_end, gam_points, tau_start, tau_end, tau_point)
...
passivewalker_k_tau_Garcia_default(q,u,gamma,tau);
%  save q1.mat q;
%  save u1.mat u;
%  save gam.mat gamma;
%  save th.mat tau;
...
%20211019last
%paramaker_k_tau_Garcia_default(0.34,0.47,13, -3.0, -2.0, 10, 0.1, 0.3, 20, 0.01, 0.3, 30)
